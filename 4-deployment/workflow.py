...
from step_8_render import render_email_html, render_html
from step_9_save import save_html
from step_10_send_email import send_email
...
@observe(name="job-digest-workflow")
def run():
    scraped = scrape()
    ...
    email_html = render_email_html(matched, screened_count, project_dir)
